...
const { REACT_APP_CHANGE_PASSWORD_PATH } = process.env;
...
export const RESET_PASSWORD_PATH = REACT_APP_RESET_PASSWORD_PATH ?? 'http://localhost:8000/forgotPassword';
export const CHANGE_PASSWORD_PATH = REACT_APP_CHANGE_PASSWORD_PATH ?? 'http://localhost:8000/changePassword';
